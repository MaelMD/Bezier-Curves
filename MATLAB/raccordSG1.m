...
%%   Exemple de raccord G1 de deux surfaces de Bézier
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%
%% modification pour un raccord G1
%% on déplace les points de contrôle
%%
for k2=1:np4
  x1=XP1(np1-1,k2);y1=YP1(np1-1,k2);z1=ZP1(np1-1,k2);
  x0=XP1(np1,k2);y0=YP1(np1,k2);z0=ZP1(np1,k2);
% x0=XP2(1,k2);y0=YP2(1,k2);z0=ZP2(1,k2);
  x2=XP2(2,k2);y2=YP2(2,k2);z2=ZP2(2,k2);
% on aligne les points à abscisse invariante
  lambda=(x2-x0)/(x1-x0);
  xa=x0+lambda*(x1-x0);
  ya=y0+lambda*(y1-y0);
  za=z0+lambda*(z1-z0);
  XP2(2,k2)=xa;YP2(2,k2)=ya;ZP2(2,k2)=za;
end
%%
