...
#l'equation du courbe  quadratique est:
    # B(t)x=(1-t)^2*P0x+2(1-t)*t*P1x+t^2*P2x
    #B(t)y=(1-t)^2*P0y+2(1-t)*t*P1y+t^2*P2y
...
# l'equation est 
#B(t)x=(1-t)^3*P0x+3*(1-t)^2P1x+3*(1-t)^2*P2x+t^3*P3x
#B(t)y=(1-t)^3*P0y+3*(1-t)^2P1y+3*(1-t)^2*P2y+t^3*P3y
